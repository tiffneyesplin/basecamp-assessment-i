...
var trueFaveNum = faveNum === faveNum
...
var responseCreator = function(param){
  ...
  if (param === 'red') {colorResponse = "I heart red"}
  else if (param != "green" && param != "red") {colorResponse = 'What is your favorite color?'}
...
function greeter (name1, num1){
  name1 = ("Hi! I am Bryan")
  num1 = (" and I am 28 years old")
